...
void fiesta::Parameters::SetParameters() {
  resolution_ = 0.1;
  visualize_every_n_updates_ = 1;
  min_ray_length_ = 0.5;
  max_ray_length_ = 5.0;
  ...
  slice_vis_max_dist_ = 2.0;
  slice_vis_level_tmp = 5.0;
  vis_lower_bound_tmp = -5.0;
  vis_upper_bound_tmp = 10.0;
  ...
  center_x_ = 322.477357419;
  center_y_ = 237.076346481;
  focal_x_  = 384.458089392;
  focal_y_  = 383.982755697;

  ray_cast_num_thread_ = 0;
  ...
  depth_filter_tolerance_ = 0.1;
  depth_filter_max_dist_ = 10.0;
  depth_filter_min_dist_ = 0.1;
  depth_filter_margin_  = 0;
